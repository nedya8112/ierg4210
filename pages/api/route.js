    ...
    if (req.method === 'GET') {
        ...
        try {
            ...
            if (type === 'add-category') {
                ...
                const { cid, name, price, description, quantity } = req.body;
                await db.run('INSERT INTO products (cid, name, price, description, quantity) VALUES (?, ?, ?, ?, ?)',
                    cid, name, price, description, quantity
                );
            }
            // DELETE
